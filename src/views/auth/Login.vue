            ...
            <div
                ...
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    <div class="text-center mb-8 flex flex-col items-center gap-2">
                        <img class="w-[50px] h-[50px]" src="@/assets/images/logo.svg" />
                    ...
                    <div>
                        ...
                        <InputText
                            id="username" v-model="account.username" class="w-full md:w-[30rem] mb-4" placeholder="请输入账号"
                            type="text" />
                        ...
                        <Password
                            id="password" v-model="account.password" :feedback="false" :toggle-mask="true"
                            class="mb-4 md:w-[30rem]" fluid placeholder="请输入密码"></Password>

                        <!-- 验证码 -->
                        <label
                            class="block text-surface-900 dark:text-surface-0 font-medium mb-2"
                            for="captcha">验证码</label>
                        <div class="flex items-center justify-between gap-4 md:w-[30rem] mb-8">
                            <InputText
                                id="captcha" v-model="account.captcha" class="w-full" placeholder="请输入验证码"
                                type="text" />
                            <!-- 验证码图片 -->
                        ...
                        <Button :loading="loading" class="w-full" label="登录" @click="handleLogin"></Button>
                    </div>
                </div>
            </div>
        </div>
