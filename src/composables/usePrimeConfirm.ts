...
export const usePrimeConfirm = () => {
    ...
    const confirmDelete = async (options: ConfirmationOptions) => {
        ...
        const { message = '确定要删除吗？', header = '删除', accept, reject, acceptLabel = '确认', rejectLabel = '取消', ...rest } = options;
    ...
    const confirmInfo = async (options: ConfirmationOptions) => {
        const { message, header = '提示', accept, reject, acceptLabel = '确认', rejectLabel = '取消', ...rest } = options;
        const confirmOptions: ConfirmationOptions = {
            ...rest,
            message,
            header,
    ...
    const confirmSuccess = async (options: ConfirmationOptions) => {
        const { message, header = '成功', accept, reject, acceptLabel = '确认', rejectLabel = '取消', ...rest } = options;
        const confirmOptions: ConfirmationOptions = {
            ...rest,
            message,
            header,
    ...
    const confirmWarning = async (options: ConfirmationOptions) => {
        const { message, header = '注意', accept, reject, acceptLabel = '确认', rejectLabel = '取消', ...rest } = options;
        const confirmOptions: ConfirmationOptions = {
            ...rest,
            message,
            header,
