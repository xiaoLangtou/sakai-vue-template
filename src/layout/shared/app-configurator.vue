...
import {
    NOIR_SEMANTIC_COLORS,
    OTHER_SEMANTIC,
    PRIMARY_COLOR_MAP,
    PRIMARY_COLORS,
    SURFACE_COLORS
} from '@/preferences/colors.ts';
...
<template>
    <CustomDrawer
        :show-default-footer="true" :visible="props.visible" header="系统配置" subheader="自定义偏好设置 & 实时预览" position="right"
        style="width: 420px;" @update:visible="emit('update:visible', $event)">
            ...
            <AppConfigCard title="主题颜色">
                <div class="color-grid">
                    <div
                        ...
                        class="color-option group rounded-md hvr-wobble-skew"
            ...
            <AppConfigCard title="布局模式">
                <div class="layout-mode-options">
                    <div
                        ...
                        class="layout-mode-option group"
