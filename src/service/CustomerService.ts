import type { Customer, ICustomerService, CustomerStatus } from '@/types/customer';
...
export const CustomerService: ICustomerService = {
        ...
        return [
            {
                ...
                date: '2015-09-13',
                status: 'unqualified' as CustomerStatus,
                verified: true,
                activity: 17,
                representative: {
                    name: 'Ioni Bowcher',
            ...
            },
            {
                ...
                date: '2017-05-13',
                status: 'qualified' as CustomerStatus,
                verified: false,
                activity: 63,
                representative: {
                    name: 'Asiya Javayant',
            ...
            },
            {
                ...
                date: '2018-02-19',
                status: 'renewal' as CustomerStatus,
                verified: true,
                activity: 54,
                representative: {
                    name: 'Ivan Magalhaes',
    ...
    getCustomers(params?: Record<string, any>): Promise<Customer[]> {
