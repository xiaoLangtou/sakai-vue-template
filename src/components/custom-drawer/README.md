...
<template>
    <div>
        ...
        <CustomDrawer v-model:visible="visible" header="抽屉标题" :show-default-footer="true" @confirm="handleConfirm" @cancel="handleCancel">
            <p>这里是抽屉的内容</p>
        </CustomDrawer>
    </div>
</template>
...
```vue
<CustomDrawer v-model:visible="visible" header="编辑用户" :show-default-footer="true" :confirm-loading="loading" @confirm="handleSubmit">
